                ...
                <div className='flex flex-col gap-4 py-6'>
                  ...
                  <div className='space-y-3'>
                    {task?.team?.map((m, index) => (
                      <div key={index + m?._id} className='flex gap-4 py-2 items-center border-t border-gray-200'>
                ...
                {task?.subTasks?.length > 0 && (
                  <div className='space-y-4 py-6'>
                    <div className='flex items-center gap-5'>
                      ...
                      <div className={`w-fit h-8 px-2 rounded-full flex items-center justify-center text-white ${percentageCompleted < 50
                        ? "bg-rose-600"
                        ...
                        <div key={index + el?._id} className='flex gap-3'>
                          ...
                          <div className='space-y-1'>
                            <div className='flex gap-2 items-center'>
                              ...
                              <span className={`px-2 py-0.5 text-center text-sm rounded-full font-semibold ${el?.isCompleted
